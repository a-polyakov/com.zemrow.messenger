...
public class UserContactDaoTest extends AbstractTest {
    ...
    public void test() {
        try (final DataBase dataBase = getDataBase()) {
            dao = new UserContactDao(dataBase);
            ...
            final UserContact entity2 = dao.select(entity.getKey());
...
//
            ...
            final UserContact entity3 = dao.select(entity.getKey());
            ...
            final UserContact entity4 = dao.select(entity.getKey());
