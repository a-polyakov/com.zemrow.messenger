...
public class NumberingDaoTest extends AbstractTest {
    ...
    public void test() {
        try (final DataBase dataBase = getDataBase()) {
            ...
            final Numbering entity2 = dao.select(entity.getKey());
            ...
            final Numbering entity3 = dao.select(entity.getKey());
            ...
            final Numbering entity4 = dao.select(entity.getKey());
