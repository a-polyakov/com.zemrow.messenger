...
public class RunDemo {
    ...
    public void demo(boolean voiceEnable) throws Exception {
        ...
        try {
            ...
            final HomePage homePageA = new HomePage(userA);
            ...
            // Регистрация
            speak("Нам потребуется ввести логин, пароль и повторить ввод пароля чтобы исбежать ошибки.");
            ...
            final HomePage homePageB = new HomePage(userB);
            ...
            Assert.assertEquals(usernameB, homePageA.waitElement(By.xpath("//table[contains(@class,'user_info_dialog')]//td[@class='username']")).getText());
    ...
    /**
     * Метод выполняет открытие окна, развертывание окна.
     */
    ...
    public void speak(String text, int waitMillis) throws Exception {
        if (voiceEnable && userA instanceof JavascriptExecutor) {
//            ((JavascriptExecutor) userA).executeScript("ui.utils.speak(arguments[0])", text);
    ...
    public static void main(String[] args) throws Exception {
        new WebDriverRunner(RunDemo.class);
